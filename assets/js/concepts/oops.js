/**
  ...
  i) Encapsulation
  - In Object Oriented programming we group releated variables and functions that operate on them into objects.
  ii) Abstraction
  - In objects we hide some of the methods and properties from the outside and this gives us a couple of benifits.
    a) We maked interface of that object simpler i.e only few properties and methods need to be known for the working of the object.
  ...
  i) Encapsulation - Reduce Complexity + Increase Reuseability
